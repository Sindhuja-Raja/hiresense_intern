...
const SignIn = () => {
  ...
  useEffect(() => {
    ...
    root.classList.remove('dark', 'theme-recruiter');
    ...
    <div className="min-h-screen w-full flex flex-col lg:flex-row overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50">
      ...
      <div className="relative z-10 w-full h-full flex flex-col">
        ...
        <div className={`absolute top-8 ${userType === 'recruiter' ? 'left-8' : 'right-8'} flex items-center gap-3 z-20 transition-all duration-500 ease-in-out`}>
          ...
          <span className="text-xl font-bold text-white">Recruitment Portal</span>
        </div>
      ...
      <div className={`flex-1 flex flex-col min-h-screen lg:min-h-0 ${userType === 'applicant' ? 'lg:order-1' : 'lg:order-2'}`}>
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-lg font-bold text-white">Recruitment Portal</span>
          </div>
        </div>
            ...
            <div className="mb-6 p-4 bg-gradient-to-r from-blue-50 to-cyan-50 border-2 border-blue-200 rounded-xl">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-bold text-blue-900 mb-1">Company Recruiter Access</h3>
                  <div className="space-y-1">
                    <p className="text-xs text-blue-700">
                      <span className="font-semibold">Email:</span> recruiter@company.com
                    </p>
                    <p className="text-xs text-blue-700">
                      <span className="font-semibold">Password:</span> Recruiter@123
                    </p>
                  </div>
                  <p className="text-xs text-blue-600 mt-2 italic">
                    ℹ️ Other credentials will access applicant dashboard
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className={`relative group transition-all duration-300 ${focused === 'email' ? 'transform scale-[1.02]' : ''}`}>
                    ...
                    <Input
                      ...
                      required
                      style={{ WebkitTextFillColor: '#0f172a', caretColor: '#0f172a' }}
                      className={`auth-input h-12 pl-12 pr-4 bg-white/80 border-2 rounded-xl text-slate-900 placeholder:text-slate-400 transition-all duration-300 ${
                        focused === 'email' 
